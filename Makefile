...
release: check
	...
	@echo "==============================================="
	rm -rf _build/prod/rel/discord_webhook_manager
	MIX_ENV=prod $(MIX) release
	@echo ""
	@echo "✓ Release built successfully"
	@echo "Location: _build/prod/rel/discord_webhook_manager/"
	@echo ""
...
publish-release: release
	...
	TARBALL="discord_webhook_manager-$$VERSION.tar.gz"; \
	echo "Version: $$VERSION"; \
	echo "Creating release tarball..."; \
	tar -czf "$$TARBALL" -C _build/prod/rel discord_webhook_manager/; \
	...
	if gh release view "v$$VERSION" >/dev/null 2>&1; then \
		...
		gh release create "v$$VERSION" "$$TARBALL" \
			...
			--notes "Discord Webhook Manager Elixir release v$$VERSION. Download and deploy with Jenkins." \
			--draft=false; \
	fi; \
